<?php
	function db_connect(){
		$conn = mysqli_connect("localhost", "admin", "admin", "db_a6b5e8_store");
		if(!$conn){
	...
	function select4FirsttBook($conn){
		$row = array();
		$query = "SELECT book_isbn, book_image,book_title, book_price FROM books ORDER BY book_isbn ASC";
