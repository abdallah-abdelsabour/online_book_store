                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <a class="dropdown-item" href="category.php?books_id=4">self development</a>
                            ...
                            <li class="navbar-item">
                                <a href="#" class="nav-link" style="">About</a>
                            </li>
                            <li class="navbar-item">
                                <a href="logout.php" class="nav-link" style="color:#ff9700;">Logout</a>
                            </li>
                            <li class="navbar-item active">
                                <a href="shipping.php" class="nav-link" style="color:#ff9700;">shiping </a>
                            </li>
                        </ul>
                        <a href="cart.php">
                         ...
                         <a style="color:black; margin-left:47;" href="admin.php"> admin</a>
